                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="left">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="" class="logo"><img src="{{ asset('storage') . '/' . $setting->header_image }}" alt=""></a>
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="item-footer mb-3 mb-md-0">
                        <figure><img src="{{ asset('storage') . '/' . $setting->footer_image }}" alt=""></figure>
                        <p>
                ...
                <div class="col-md-2">
                    <div class="item-footer mb-3 mb-md-0">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ route('products_page.index') }}">Products</a></li>
                            <li><a href="{{ route('gallery.gallery') }}">Gallery</a></li>
                            <li><a href="{{ route('about.index') }}">About us</a></li>
                            <li><a href="#">Client</a></li>
                        </ul>
