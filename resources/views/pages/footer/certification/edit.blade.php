...
@section('page_title', 'Footer Certification Edit')
...
@section('nav_title', 'Footer Certification Edit')
...
@section('content')
    <div class="card card-p-0 card-flush">
        ...
        <div class="card-body mb-5">
            <form action="{{ route('certification.footerUpdateCertification', ['id' => $certification->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-10">
                    ...
                    <div class="image-input image-input-empty" data-kt-image-input="true"
                        ...
                        <div class="image-input-wrapper w-160px h-125px" style="width: 250px; background-image: url({{ asset('storage') . '/' . $certification->image }})"></div>
