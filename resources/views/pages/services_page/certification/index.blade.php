...
@section('page_title', 'Certification')

@section('css')
    {{--    <link href="{{ asset('assets/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet"/>--}}
@endsection

@section('nav_title', 'Certification')
    ...
    <div class="card card-p-0 card-flush">
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5" style="margin-top: 40px !important;">
                <a href="{{ route('certification.create') }}" class="btn btn-success">Add Certification</a>
            </div>
        </div>
        <div class="card-body">
                ...
                @foreach($certifications as $certification)
                    <tr class="odd">
                        ...
                        <td class="text-end d-flex justify-content-center">
                            <a href="{{ route('certification.edit', ['id' => $certification->id]) }}" class="btn btn-primary mx-3" style="width: 90px;">
                            ...
                            <form action="{{ route('certification.delete', ['id' => $certification->id] )}}" method="POST">
                                @csrf
                                @method('DELETE')
