...
@section('page_title', 'Service Page Edit')
...
@section('nav_title', 'Service Page Edit')
...
@section('content')
    <div class="card card-p-0 card-flush">
        ...
        <div class="card-body mb-5">
            <form action="{{ route('services_page.update', ['id' => $service->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
