                ...
                @foreach($contacts as $contact)
                    <tr class="odd">
                        ...
                        <td class="d-flex justify-content-center">
                            <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#kt_modal-{{ $contact->id }}" style="height: 40px">
                                <i class="fa-regular fa-eye"></i>
                                Show
                            </button>
                            <form action="{{ route('contact_us.delete', ['id' => $contact->id]) }}" method="POST">
                                @csrf
                                @method('DELETE')

                                <button href="{{ route('contact_us.delete', ['id' => $contact->id]) }}" class="btn btn-danger mx-3" style="width: 110px; height: 40px">
                    ...
                    {{-- Message Modal --}}
                    <div class="modal fade" tabindex="-1" id="kt_modal-{{ $contact->id }}">
