            ...
            <table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
                <thead>
                    ...
                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase">
                        ...
                        <th class="min-w-100px">Cover Image</th>
                    ...
                    @foreach ($products as $product)
                        <tr class="odd">
                            ...
                            <td class="text-end pe-0">
                                <img src="{{ asset('storage') . '/' . $product->cover_image }}" width="50"
                                    height="50">
                            </td>
                            <td class="text-end d-flex justify-content-end ">
                                ...
                                <form action="{{ route('product.delete', ['id' => $product->id]) }}" method="POST"
                                    ...
                                    <button type="submit" class="btn btn-danger" style="display: inline-flex;">
                                ...
                                <a href="{{ route('product.productShow', ['id' => $product->id]) }}" class="btn btn-warning"
                                    style="margin-right: 5px">
