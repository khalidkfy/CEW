...
@section('nav_title', 'Our Partners | Slider Images')
    ...
    <div class="card card-p-0 card-flush">
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <button href="{{ route('our_partners.index') }}" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#add_partners_image">Add Image</button>
                <div class="modal fade" tabindex="-1" id="add_partners_image">
                    <div class="modal-dialog">
                        <form action="{{ route('our_partners.addSliderImage') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Add Image From Partners Slider</h5>
            ...
            <table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
                ...
                @foreach($images as $image)
                    <tr class="odd">
                            ...
                            <div class="modal fade" tabindex="-1" id="partners_image-{{ $image->id }}">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
