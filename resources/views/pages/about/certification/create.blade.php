...
@section('page_title', 'Add About Us Certification')
...
@section('nav_title', 'Add About Us Certification')
...
@section('content')
    <div class="card card-p-0 card-flush">
        ...
        <div class="card-body mb-5">
            <form action="{{ route('certification.aboutCertificationStore') }}" method="POST" enctype="multipart/form-data">
                @csrf
