...
@section('page_title', 'About Us Certification Edit')
...
@section('nav_title', 'About Us Certification Edit')
...
@section('content')
    <div class="card card-p-0 card-flush">
        ...
        <div class="card-body mb-5">
            <form action="{{ route('certification.aboutUpdateCertification', ['id' => $certification->id]) }}"
                ...
                <div class="mb-10">
                    ...
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                           placeholder="Put Some Words For Title Here"
