...
@section('content')
    <div class="card card-p-0 card-flush">
        ...
        <div class="card-body mb-5">
            <form action="{{ route('about.update', ['id' => $about_us->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-10">
                    <label for="kt_docs_ckeditor_classic" class="required form-label">Long Description</label>
                    <textarea name="long_description" id="kt_docs_ckeditor_classic" class="@error('long_description') is-invalid @enderror">
                ...
                <div class="mb-10">
                    ...
                    <input type="text" name="certification_title" class="form-control @error('certification_title') is-invalid @enderror" placeholder="Put Some Words For Title Here"
                           value="{{ $about_us->certification_title }}"/>
